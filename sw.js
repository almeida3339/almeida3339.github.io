// A CADA ATUALIZAÇÃO IMPORTANTE, MUDE O NÚMERO DA VERSÃO (v3, v4...)
const CACHE_NAME = 'achados-de-cozinha-v3';
const IMAGE_CACHE_NAME = 'achados-imagens-v1';

const urlsToCache = [
  '/', '/index.html', '/style.css', '/script.js',
  '/products.json', '/perfil.jpg', '/politica-de-privacidade.html',
...
self.addEventListener('fetch', event => {
  ...
  // Se for uma imagem da nossa pasta /images/, usa a estratégia stale-while-revalidate
  if (url.pathname.startsWith('/images/')) {
    event.respondWith(staleWhileRevalidate(request));
  } else {
    // Para todos os outros arquivos, usa a estratégia Cache First
